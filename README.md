...
(See my website￼ for the full, up-to-date list.)

📚 Selected Publications
	•	Revisiting LLM Evaluation through Mechanism Interpretability: A New Metric and Model Utility Law — Paper￼ • Code￼ • Project￼
	•	Disentangling Language Medium and Cultural Context for Evaluating Multilingual LLMs (ACL 2025) — Code￼ • Project￼
	•	Automating Dataset Updates Towards Reliable and Timely Evaluation of LLMs (NeurIPS 2024) — Paper￼ • Code￼ • Project￼
	•	LLMs-as-Instructors: Learning from Errors Toward Automating Model Improvement (EMNLP 2024, Findings) — Paper￼ • Code￼ • Project￼
	•	Intuitive or Dependent? Investigating LLMs’ Behavior Style to Conflicting Prompts (ACL 2024, Main) — Paper￼ • Code￼
